...
<body>
	...
	<!--Navbar--> <nav class="navbar navbar-expand-lg navbar-dark"
		style="backgroud-color : white; margin-left : 150px; margin-right : 150px; margin-bottom : 15px;">
	...
	<div id="carousel-example-1z" class="carousel slide carousel-fade"
		data-ride="carousel" style="margin-left: 150px; margin-right: 150px; margin-bottom: 15px;">
		<!--Indicators-->
	...
	<footer class="page-footer font-small unique-color-dark pt-4"
		style="margin-left: 150px; margin-right: 150px;"> <!-- Footer Elements -->
	<div class="container">
	...
	<!-- Copyright --> <!-- // Footer--> <!-- SCRIPTS --> <!-- JQuery --> <script
		type="text/javascript" src="resources/js/jquery-3.3.1.min.js"></script>
	<!-- Bootstrap tooltips --> <script type="text/javascript"
